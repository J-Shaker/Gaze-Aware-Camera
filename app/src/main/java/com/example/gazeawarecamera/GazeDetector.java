...
public class GazeDetector {
     ...
     * making any part of the UI static causes a memory leak.
     */
    ...
    private ArrayList<Point> getPupilCoordinates(Mat greyImage, Rect faceBoundingBox) {
        ...
        for (int i = 0; i < eyeBoundingBoxes.length; i++) {
            ...
            Bitmap eye = convertMatToBitmap(greyEye);
            Bitmap pupil = convertMatToBitmap(binaryEye);
            ...
            for (int j = 0; j < keyPointsArray.length; j++) {
                ...
                System.out.println("Eye: " + i + ", pupil " + j + ": " + adjustedPoint.toString());
    ...
    public int detectGazesWithDistances(@NonNull List<Face> faces, Image originalImage) {
        /*
        ...
        for (int i = 0; i < faces.size(); i++) {
            /*
             * First, we'll get the bounding box of our current face. We need to perform an
             * operation on the box so that it appears correctly when drawn on the screen. That is
             * what the correctBoundingBox method does. We add the corrected Rect object to the
             * list of bounding boxes.
             */
            android.graphics.Rect faceBoundingBox = faces.get(i).getBoundingBox();
            faceBoundingBoxes.add(correctBoundingBox(faceBoundingBox));
            /*
             ...
             * we also obtained earlier. We can pass those into our method and get back the list of
             * coordinates. The list should have a size of two, but it could be larger. We discuss
             * that below.
             */
             ...
             * values to occur because this will tell us which direction the eye is looking.
             */
        ...
        /*
         * Finally, we call our drawing method with the list of bounding boxes we've added to, and
         * return our final number of gazes detected.
         */
        drawingListener.drawRectangles(faceBoundingBoxes);
